  ...
  return (
    <AppLayout title="Modifications">
      <Tabs defaultValue="positions">
        ...
        <TabsContent value="categories" className="mt-4 grid gap-4 md:grid-cols-[320px_1fr]">
          <Card className="h-fit">
            <CardHeader>
        ...
        <TabsContent value="phases" className="mt-4 grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
        ...
        <TabsContent value="accounting" className="mt-4 grid gap-4 md:grid-cols-[320px_1fr]">
          <Card className="h-fit">
            <CardHeader>
